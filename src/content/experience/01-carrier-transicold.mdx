...
description: "Established the site's firmware development capability from zero. First Transicold embedded software engineer at the Monterrey Technology Hub, working on a multi-ECU refrigeration platform."
responsibilities:
  ...
  - "Developed firmware following a V-model process on a multi-ECU refrigeration platform, covering implementation and validation across ARM Cortex-M4 (embOS) and ARM Cortex-M7 (MQX) targets."
